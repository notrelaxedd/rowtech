...
export const FORCE_SPECS: readonly Spec[] = [
  ...
  ["Fits", "[OWNER: which riggers and boats it fits: rigger types, stay diameter range, sweep/scull, tested boats]"],
  ...
  ["Doesn’t measure", "[OWNER: confirm what Force doesn’t measure, e.g. oar angle, power, boat speed]"],
