...
export default async function LoginPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const failed = q.error === "link" ? "That link has expired or was already used. Sign in with your password instead." : q.error === "google" ? "Google sign-in didn't come back. Try again, or use your password." : "";
