...
// Where Google lands, and any magic link already sitting in an inbox. Swaps the
// code for a session, then sends the visitor on. `next` is kept relative so it
// can't bounce off-site.
