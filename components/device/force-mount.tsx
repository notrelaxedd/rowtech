  ...
  return (
    <figure className={className}>
      <svg
        viewBox={`0 0 ${W} ${H}`}
        role="img"
        aria-label="Schematic: the load cell sits in the rigger's backstay and the Force node clamps to the stay in front of the rower, where the oar handle sweeps over it."
      ...
      >
        ...
        <text x={26} y={352} fill={SCREEN.label} fontFamily={mono} fontSize={13} letterSpacing={1.2}>
          HULL
        </text>
        ...
        <text x={126} y={132} fill={SCREEN.label} fontFamily={mono} fontSize={13} letterSpacing={1.2}>
          MAIN ARM
        </text>
        <line x1={22} y1={310} x2={438} y2={206} stroke="rgb(255 255 255 / 0.34)" strokeWidth={5} strokeLinecap="round" />
        <text x={126} y={324} fill={SCREEN.label} fontFamily={mono} fontSize={13} letterSpacing={1.2}>
          BACKSTAY
        </text>
        ...
        <text x={468} y={204} fill={SCREEN.label} fontFamily={mono} fontSize={13} letterSpacing={1.2}>
          PIN
        </text>
        ...
        <text x={214} y={300} fill={SCREEN.trace} fontFamily={mono} fontSize={13} letterSpacing={0.8}>
          load cell
        </text>
        ...
        <text x={344} y={96} fill={SCREEN.value} fontFamily={mono} fontSize={14} letterSpacing={0.8}>
          Force node
        </text>
        ...
        <text x={104} y={44} fill={SCREEN.ok} fontFamily={mono} fontSize={13} letterSpacing={0.6}>
          handle sweeps over
        </text>
      </svg>
    </figure>
